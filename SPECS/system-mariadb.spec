...
rm -f ${RPM_BUILD_ROOT}%{sandbox}%{_mandir}/man1/aria_chk.1*
rm -f ${RPM_BUILD_ROOT}%{sandbox}%{_mandir}/man1/aria_dump_log.1*
rm -f ${RPM_BUILD_ROOT}%{sandbox}%{_mandir}/man1/aria_ftdump.1*
rm -f ${RPM_BUILD_ROOT}%{sandbox}%{_mandir}/man1/aria_pack.1*
rm -f ${RPM_BUILD_ROOT}%{sandbox}%{_mandir}/man1/aria_read_log.1*
